				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-10">
					<div>
						<svg
							...
							viewBox="0 0 32 32"
							class="w-16 text-[#00e9a3] m-inline-auto block"
						>
						...
						<h3 class="font-bold text-xl mt-5 text-white">Fast</h3>
					...
					<div>
						...
						<h3 class="font-bold text-xl mt-5 text-white">Simple</h3>
					...
					<div>
						...
						<h3 class="font-bold text-xl mt-5 text-white">Robust</h3>
