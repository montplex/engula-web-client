		...
		<div class="content">
			<div class="home-footer pb-12">
				...
				<div class="meta-walk md:py-14 py-8">
					...
					<a href="#">
						<svg role="img" width="20" class="text-white text-xl" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
							<path
								fill="currentColor"
				...
				<div class="md:my-10 py-6 text-lg text-white">© 2022 Montplex, Inc. All rights reserved</div>
				<div
