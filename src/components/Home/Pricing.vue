<template>
	<section class="ly-box">
		...
		<div class="content">
			...
			<PricingChild />
			<!-- meat -->
			<div class="flex items-center flex-col mt-14 text-white" style="font-family: 'Airbnbcereal book'">
				...
				<p>
					...
					<a
						...
						href="https://docs.upstash.com/redis/overall/pricing#pay-as-you-go-plan-quotas"
					>
						quotas
					</a>
